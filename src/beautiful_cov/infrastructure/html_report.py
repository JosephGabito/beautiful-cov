...
class StaticHtmlReportWriter:
    ...
    def _write_dashboard(
        ...
        project_rows.extend(self._file_row(file) for file in root.files)
    ...
    def _write_directory(
        ...
        rows.extend(self._file_row(file) for file in directory.files)
    ...
    def _file_row(self, file: FileCoverage) -> CoverageRow:
    ...
    def _health_groups(self, report: CoverageReport) -> tuple[HealthGroup, ...]:
        ...
        return (
            group("strong", CoverageStatus.STRONG),
            group("watch", CoverageStatus.WATCH),
            group("critical", CoverageStatus.CRITICAL),
        )
